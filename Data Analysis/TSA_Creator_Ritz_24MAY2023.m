...
load('2023StudyAsExample_TSA.mat') %import your .mat file for quick access; Case sensetive
...
%The following only plots the Means, this is what is used to generate the
%error in future figures, only run if you need to debug
